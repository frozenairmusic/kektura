  ...
  public GpxSegmentDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfGpxSegment = new EntityInsertionAdapter<GpxSegment>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR IGNORE INTO `gpx_segments` (`id`,`name`,`region`,`distanceKm`,`gpxContent`,`hasData`,`visible`,`lastUpdated`) VALUES (?,?,?,?,?,?,?,?)";
      }
      ...
      protected void bind(@NonNull final SupportSQLiteStatement statement,
        ...
        statement.bindDouble(4, entity.getDistanceKm());
        if (entity.getGpxContent() == null) {
          statement.bindNull(5);
        } else {
          statement.bindString(5, entity.getGpxContent());
        }
        ...
        if (entity.getLastUpdated() == null) {
          ...
          statement.bindString(8, entity.getLastUpdated());
        }
      }
    };
      ...
      public List<GpxSegment> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new GpxSegment(_tmpId,_tmpName,_tmpRegion,_tmpDistanceKm,_tmpGpxContent,_tmpHasData,_tmpVisible,_tmpLastUpdated);
            _result.add(_item);
          }
          return _result;
        } finally {
      ...
      public GpxSegment call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            _result = new GpxSegment(_tmpId,_tmpName,_tmpRegion,_tmpDistanceKm,_tmpGpxContent,_tmpHasData,_tmpVisible,_tmpLastUpdated);
          } else {
            _result = null;
          }
          return _result;
